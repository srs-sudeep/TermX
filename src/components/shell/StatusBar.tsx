...
/**
 * Bottom status bar — IDE-style strip rendered below the terminal.
 *
 * Sections (left → right):
 *  - Online indicator with a pulsing dot.
 *  - Active theme name.
 *  - Total commands run this session (a fun engagement metric).
 *  - Right-aligned keyboard hints (`Tab` / `↑↓` / `Ctrl+L`) and a live clock.
 *
 * Updates the clock once a second. The component renders nothing
 * heavy — it's purely informational.
 */
